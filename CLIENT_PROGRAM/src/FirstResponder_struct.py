...
"""
@file defines the firstResponder wearable beacon object structure.
"""
...
class firstResponder():
    ...
    # object constructor
    def __init__(self, uuid, location_id, timestamp, quadrant, steps, closest_anchor, current_floor):
        # beacon UUID
        self.uuid = uuid
        # beacon location_id
